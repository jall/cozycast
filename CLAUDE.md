...
A second workflow, `keepalive.yml`, runs on its own daily schedule and is
unrelated to testing — see "Keeping the free-tier projects awake" under
**Supabase**.
...
### Keeping the free-tier projects awake
